public class TestGeneric {
    public static void main(String[] args) {
        ...
        DoublyLinkedListGen<Integer> integerList = new DoublyLinkedListGen<Integer>();
        DoublyLinkedListGen<String> stringList = new DoublyLinkedListGen<String>();
        ...
        String elem1 = (String) stringList.getFirst();
